      ...
      <div className="max-w-4xl mx-auto py-4 sm:py-8 px-3 sm:px-6 lg:px-8">
        ...
        <div className="flex justify-center mb-8">
          <div className="flex items-center space-x-4">
            ...
            >
              <div
                className={`w-8 h-8 rounded-full flex items-center justify-center border-2 ${currentStep >= 1 ? 'border-blue-600 bg-blue-600 text-white' : 'border-gray-300'}`}
              >
                1
              </div>
            ...
            >
              <div
                className={`w-8 h-8 rounded-full flex items-center justify-center border-2 ${currentStep >= 2 ? 'border-blue-600 bg-blue-600 text-white' : 'border-gray-300'}`}
              >
                2
              </div>
                  ...
                  {formData.custom_location_neighborhood && (
                    <div className="bg-green-50 border border-green-200 rounded-lg p-3 mb-4">
                      <div className="text-sm text-green-800">
                        ...
                        {
                          formatLocation({ neighborhood: formData.custom_location_neighborhood })
                            .neighborhood
                        }
                        {addressVerified && (
